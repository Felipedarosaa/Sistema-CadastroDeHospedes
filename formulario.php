...
if (isset($_POST['submit'])) {
    ...
    $result = mysqli_query($conexao, "INSERT INTO usuarios(nome,cpf,email,senha,telefone,cidade,estado,endereco,pessoas,data_entrada,data_saida,quarto,valor) 
        VALUES ('$nome','$cpf','$email','$senha','$telefone','$cidade','$estado','$endereco','$pessoas','$data_entrada','$data_saida','$quarto','$valor')");
